...
void android_main(struct android_app* state)
{
	...
	siika->init();
	Texture* kakkatekstuuri = siika->loadTexture("kakka.png");
	Sprite* kakkasprite = siika->newSprite(kakkatekstuuri);
	kakkasprite->setTexture(kakkatekstuuri);


	while (1)
	{

		kakkasprite->move(-1, -1);
